...
In the [PCIdep paper](https://doi.org/10.1080/01621459.2026.2707221), we show that a $p$-value for $H_0^{\{C_1,C_2\}}$ can be computed in closed form, provided that
...
<div style="border-left: 4px solid #e6a817; background-color: #fdf6e3; padding: 12px 16px; margin: 16px 0; border-radius: 4px;">
  ...
  where $\mathbf{1}_{n\times n}$ is the $n \times n$ matrix of ones. In the [PCIdep paper](https://doi.org/10.1080/01621459.2026.2707221), we show that the testing
...
The closed form of the $p$-value when $\mathbf{U} \in \mathcal{CS}(n)$ is detailed in Section 2 of the [PCIdep paper](https://doi.org/10.1080/01621459.2026.2707221).
...
Technical details on the estimation of $\boldsymbol{\Sigma}$ and the resulting asymptotic validity of the $p$-values are provided in Section 3 of the [PCIdep paper](https://doi.org/10.1080/01621459.2026.2707221).
