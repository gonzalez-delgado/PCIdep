...
<div style="border-left: 4px solid #e6a817; background-color: #fdf6e3; padding: 12px 16px; margin: 16px 0; border-radius: 4px;">
  ...
  classical test as if the clusters had been fixed in advance, the resulting $p$-values loose the type I error control. This happens because clustering algorithms are designed to find groups that look different.
